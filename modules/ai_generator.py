...
def ai_generate_product_ideas(game_name):
    ...
    prompt = f"""Ты — лучший продавец на FunPay. Придумай 12 уникальных и востребованных товаров для игры '{game_name}' на РУССКОМ ЯЗЫКЕ.
...
def ai_translate_to_en(text):
    ...
    prompt = f"Translate the following Russian gaming text to English. Output ONLY the translation:\n\n{text}"
    for model_name in ["gpt-4o", "gpt-3.5-turbo"]:
        try:
            response = g4f.ChatCompletion.create(
                model=model_name, 
