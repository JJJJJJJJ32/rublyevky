...
def get_session(network_session=None, fresh=False):
    """
    Авторизуется на FunPay по Golden Key.
    Возвращает готовую сессию или None (с понятной причиной в консоли).
    """
    ...
    if session is None:
        # Сессию не передали — создаём свою (обычный requests.Session).
        import requests
